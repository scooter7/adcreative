...
def main():
    ...
    text_colors = [(0, 0, 0) if st.checkbox("Text Color (Black)") else (255, 255, 255) if st.checkbox("Text Color (White)") else None]

    bg_colors = [None]
    bg_colors += [(0, 0, 0) if st.checkbox("Text Background Area (Black)") else (255, 255, 255) if st.checkbox("Text Background Area (White)") else None]
